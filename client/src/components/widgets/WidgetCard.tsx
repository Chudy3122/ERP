...
const WidgetCard: React.FC<WidgetCardProps> = ({ title, icon, actions, children, className = '' }) => {
  return (
    <div className={`flex flex-col rounded-xl border border-gray-200 bg-white shadow-sm shadow-gray-200/60 dark:border-gray-700 dark:bg-gray-800 dark:shadow-black/20 ${className}`}>
      {/* Header */}
